...
namespace ProgrammingAssignment3
    ...
    public class Game1 : Game
        ...
        Vector2 centerLocation = new Vector2(WINDOW_WIDTH / 2, WINDOW_HEIGHT / 2);
        ...
        protected override void LoadContent()
            ...
            rock0 = Content.Load<Texture2D>("greenrock");
            rock1 = Content.Load<Texture2D>("magentarock");
            rock2 = Content.Load<Texture2D>("whiterock");
